    ...
    <section id="contact" className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                If you have any questions or need further information, feel free to reach out. I look forward to hearing from you!
                </p>
            ...
            <form action="https://getform.io/f/bgdyxoja" method="POST" className="xl:pl-10 2xl:pl-20">
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    <div className="mb-4">
                        ...
                        <input type="text" name="name" id="name" autoComplete="name" required placeholder="Nathan Tjokrosaputra" className="text-field reveal-up" />
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <input type="email" name="email" id="email" autoComplete="email" required placeholder="nathan.tjokrosaputra@gmail.com" className="text-field reveal-up" />
                    </div>
                </div>
                ...
                <div className="mb-4">
                    ...
                    <textarea name="message" id="message" placeholder="Leave a Message" required className="text-field resize-y min-h-32 max-h-80 reveal-up"></textarea>
                </div>
